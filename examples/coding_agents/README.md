...
A first fix that counts the even numbers instead of summing them fails the test, and the model
reads that result and tries again; the second passes all four cases.
