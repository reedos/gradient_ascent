...
export const GET: APIRoute = async ({ site }) => {
  ...
  lines.push(`Practical examples and design guidance: six practical examples within the existing recipe Markdown pages, starting at ${abs('/recipes/document-qa.md')}, and ${abs('/design-decisions.md')}. The examples have local-model smoke records, not a quality benchmark. See ${abs('/downloads/quality-prototype-notes.md')} for scope and limitations.`);
