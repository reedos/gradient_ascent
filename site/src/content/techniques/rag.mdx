...
<MeasuredCost page="rag" level={2} compare="agentic-rag" compareLabel="Agentic RAG (level 5)" />
...
<MeasuredResult page="rag" level={2} compare="agentic-rag" compareLabel="Agentic RAG (level 5)" />
