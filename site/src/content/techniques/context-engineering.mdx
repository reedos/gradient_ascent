...
This page is sourced, not measured: every claim about what belongs in a prompt is checked against
a primary source, and no packing strategy here has been run and scored. It is illustrated.
