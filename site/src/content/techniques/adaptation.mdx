...
- <Link href="/levels/0/">Conventional software</Link>: a classical model such as the ones on the
...
- <Link href="/levels/1/">Direct prompting</Link>: a fine-tuned model can replace a long, repeated
  ...
  instructions change.
- <Link href="/levels/2/">Added context</Link>: adaptation does not substitute for
...
- <Link href="/levels/4/">Tool use</Link>: a model fine-tuned on your own tool set can produce fewer
...
- <Link href="/levels/5/">Agent loops</Link>: reinforcement fine-tuning fits
