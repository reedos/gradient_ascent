...
<Link href="/techniques/ops/">ops</Link> does. This page is sourced, not measured: what each
...
- <Link href="/levels/1/">Direct prompting</Link>: a gateway is one extra hop in front of the single
...
- <Link href="/levels/4/">Tool use</Link>: a tool definition passes through the gateway unchanged
...
- <Link href="/levels/5/">Agent loops</Link>: the number of calls a run makes is not fixed in advance,
