...
For a practical handoff evaluation, see <Link href="/examples/reviewer-feedback-loop/">draft, hand off, review, improve</Link>: separate receiving and reviewing contexts, optional parallel providers, and evidence-backed scoring. A fixed review sequence is a workflow; adaptive investigation adds agent autonomy.
