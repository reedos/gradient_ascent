...
<Link href="/techniques/agent-harness/#worked-example-a-test-automation-framework">creating a test automation project with an agent harness</Link>.
...
This pattern connects <Link href="/techniques/code-execution/">code execution</Link>,
<Link href="/techniques/function-calling/">tool calls</Link>,
<Link href="/techniques/agent-harness/">the agent harness</Link>, and
<Link href="/techniques/human-in-the-loop/">human approval</Link>.
