...
“Create a project for this new DUT using our shared Python test framework. Use the closest past
...
changes, and wait for my approval before generating the project. Produce Python code, YAML/JSON
configuration, and Markdown documentation for my review. Do not modify the shared framework or
...
This example connects <Link href="/techniques/context-engineering/">context engineering</Link>,
<Link href="/techniques/guardrails/">guardrails</Link>,
<Link href="/techniques/human-in-the-loop/">human approval</Link>, and
<Link href="/techniques/observability/">observability</Link> around the harness.
To <Link href="/techniques/evals/">evaluate the agent</Link>, independently review whether the
project implements the agreed requirements, reuses the framework appropriately, respects approvals,
and accurately reports what was and was not tested.
