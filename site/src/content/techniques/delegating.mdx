...
default behaviour: "Consider the reversibility and potential impact of your actions. You are
...
person between the model and the action — not more trust, a checkpoint. A task on the left of all
...
well as to the original task. Anthropic documents over-delegation as a behaviour to prompt
