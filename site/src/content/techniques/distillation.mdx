...
it dropped, L06 and N04, which is the shape of a capture worth keeping; the teacher's answers are a
written-down fixture, so the 30 is not a pass rate anything was measured at. The same command with
