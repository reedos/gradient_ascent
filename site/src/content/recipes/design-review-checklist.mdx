...
the report itself, the one built from measured data, the numbers come from <Link
href="/recipes/characterize-a-design/">sweeping the design over its corners</Link> and the writing
up is <Link href="/recipes/measurement-writeup/">turning a measurement session into a report</Link>.
