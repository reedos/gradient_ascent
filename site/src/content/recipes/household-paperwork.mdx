...
That last group is the one people underestimate. A document that exists and cannot be found is,
on the morning of a claim, the same as a document that does not exist. The rule is a regular
