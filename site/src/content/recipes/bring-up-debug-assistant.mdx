...
written down once, in the bench module every example on this site imports, and a second copy of it
in this file would be a second copy to keep in step with the first.
